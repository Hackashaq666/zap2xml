...
do
	...
	echo "Run zap2xml.pl"
	/zap2xml.pl -u $USERNAME -p $PASSWORD $OPT_ARGS -U -o /tmp/xmltv/raws/1.xml -c cache1
	...
	then
		...
		/zap2xml.pl -u ${USERNAME2} -p ${PASSWORD2}  $OPT_ARGS2 -U -o /tmp/xmltv/raws/2.xml -c cache2
